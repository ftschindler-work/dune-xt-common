...
// CollectiveCommunication<No_Comm> is also missing a comparison operator
// CollectiveCommunication<MPI_Comm> does not have a comparison operator either, but it has a conversion operator to
// MPI_Comm which does have operator==
